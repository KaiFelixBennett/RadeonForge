...
- **Did it actually work?** Yes — and I prove it with a base-vs-fine-tuned **A/B control**, not vibes: **79 % → 100 %** routing accuracy, **−19 %** output length, served at **~117 tok/s** on the Radeon.
...
<!-- 12B-RESULTS: appended after the 12B validation run completes -->
